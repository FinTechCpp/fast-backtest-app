...
int main(int argc, char *argv[])
{
    ...
    for(int i = 0; i < data0_size; ++i) {
        snprintf(buffer, sizeof(buffer), "%g", data0[i]);
        table->setText(i, 1, buffer);
        snprintf(buffer, sizeof(buffer), "%g", data1[i]);
    ...
    snprintf(buffer, sizeof(buffer), "%s  FY 2007", layer->getLegendIcon(0));
    table->setText(0, 1, buffer);
    snprintf(buffer, sizeof(buffer), "%s  FY 2008", layer->getLegendIcon(1));
    ...
    snprintf(buffer, sizeof(buffer), "%g", total0);
    table->setText(table->getColCount() - 1, 1, buffer);
    snprintf(buffer, sizeof(buffer), "%g", total1);
