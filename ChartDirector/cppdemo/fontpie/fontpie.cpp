...
int main(int argc, char *argv[])
{
    ...
    c->getSector(2)->setLabelStyle("Arial Bold", 12, 0xff0000);
    ...
    c->getSector(4)->setLabelStyle("Arial", 8, 0x000080)->setBackground(Chart::SameAsMainColor,
        0x000000, 2);
    ...
    c->getSector(0)->setLabelStyle("Arial Italic", 8, 0xff9999)->setBackground(0x000080,
        Chart::Transparent, 2);
    ...
    c->getSector(6)->setLabelStyle("Times New Roman Bold Italic", 8, 0x008000)->setBackground(
        0xffff00, 0x000000);
