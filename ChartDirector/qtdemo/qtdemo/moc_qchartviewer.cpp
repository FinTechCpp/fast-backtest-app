...
void QChartViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::viewPortChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::clicked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QChartViewer::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::mouseMove)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::mouseWheel)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (QChartViewer::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::mouseMoveChart)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::mouseLeaveChart)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (QChartViewer::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::mouseMovePlotArea)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (QChartViewer::*)(QEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QChartViewer::mouseLeavePlotArea)) {
                *result = 7;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QChartViewer::staticMetaObject = { {
    QMetaObject::SuperData::link<QChartImage::staticMetaObject>(),
    qt_meta_stringdata_QChartViewer.data,
...
QT_INIT_METAOBJECT const QMetaObject QViewPortControl::staticMetaObject = { {
    QMetaObject::SuperData::link<QChartImage::staticMetaObject>(),
    qt_meta_stringdata_QViewPortControl.data,
