...
class QChartImage : public QLabel
{
public:
    explicit QChartImage(QWidget *parent = 0);
    virtual ~QChartImage();
...
class QChartViewer : public QChartImage, public ViewPortManager
{
Q_OBJECT
public:
...
private:
    ...
    QChartImage *m_enhancedToolTip;     // Enhanced tooltip support
    void showToolTip(const QString& text);
    void showEnhancedToolTip(const QString& text);
    void moveEnhancedToolTip(const QPoint &p);
...
class QViewPortControl : public QChartImage, public ViewPortControlBase
{
Q_OBJECT
public:
