...
class BacktestApp(QMainWindow):
    ...
    def create_results_area(self):
        ...
        # Nouvel onglet pour l'histogramme des PnL
    ...
    def create_stats_widgets(self, stats):
        ...
        trades = stats['_trades']  # Changed from 'trades' to '_trades'
    ...
    def on_backtest_finished(self, data, stats):
        ...
        try:
            ...
            # Stocker les stats pour l'accès par d'autres méthodes (pour l'histogramme notamment)
            self.stats = stats
