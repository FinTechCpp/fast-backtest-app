...
PYBIND11_MODULE(cpp_strategies, m) {
    ...
    py::class_<StrategyBaseConfig>(m, "CppStrategyBaseConfig")
        ...
        .def_readwrite("use_atr_for_sl", &StrategyBaseConfig::use_atr_for_sl)
        .def_readwrite("use_atr_for_tp", &StrategyBaseConfig::use_atr_for_tp)
        ...
        .def_readwrite("use_minmax_for_sl", &StrategyBaseConfig::use_minmax_for_sl)
        .def_readwrite("sl_minmax_periods", &StrategyBaseConfig::sl_minmax_periods)
        .def_readwrite("sl_minmax_delta", &StrategyBaseConfig::sl_minmax_delta)
