...
class SellTrendFollowing(Strategy):
    ...
    """
    def __init__(self, base_config: StrategyBaseConfig, buy_trend_config: SellTrendConfig):
    ...
    def should_short(self):
        ...
        should_go_short = k_current < d_current and self.k_previous > self.d_previous
...
class SellTrendFollowingBA(BacktestingStrategy):
    ...
    def init(self, **kwargs):
        ...
        buy_trend_config = SellTrendConfig(
        ...
        self.config      = buy_trend_config
        self.my_strategy = SellTrendFollowing(base_config, buy_trend_config)
