...
from igtrader.backtestingpy.backtesting._util import _data_period, _as_list, _Indicator, try_
# from backtestingpy.backtesting._util import _data_period, _as_list, _Indicator, try_
...
def plot(*, results: pd.Series,
         ...
         ohlc_height=600, indicator_height=300):
    """
...
return this.labels[index] || "";
    ...
    for f in figs:
        ...
        wheelzoom_tool.maintain_focus = True
